...
| Documento | Contenido |
|---|---|
| [tablas-detalladas.md](tablas-detalladas.md) | Sondeo lineal completo por dataset y modelo (con Kappa), sondeo lineal frente a ajuste fino, eficiencia en etiquetas, desgloses por clase, equidad por fototipo (Fitzpatrick17k), evaluación cruzada *light/dark*, segmentación fuera de distribución y por arquitectura *promptable*, prueba de DeLong en tres *endpoints* y clasificador unificado jerárquico M7 |
